...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Руководство пользователя Getl","1. О продукте","2. Установка Getl","3. Работа с репозиторием Getl","4. Работа с наборами данных (dataset)","5. Процессы работы с данными","6. Работа с файловыми системами","7. Настройка Getl","8. Дополнительные возможности Getl","9. Расширение функциональности с помощью EasyEtl","10. Репозиторий примеров Getl Examples","2.1. Подключение библиотеки из репозитория Maven","2.2. Разработка скрипта Getl","2.3. Сборка скриптов в библиотеку Jar с помощью Gradle","2.4. Вызов скрипта Getl","3.1. Группировка объектов репозитория","3.2. Связывание источников в потоках","4.1. Работа с JDBC таблицами","4.2. Работа с JDBC соединениями","4.3. Работа с инкрементальными данными","5.1. Копирование данных между источниками","5.2. Запись данных в источники","5.3. Чтение данных из источника","6.1. Обработка файлов","7.1. Работа с конфигурациями","7.2. Логирование работы скриптов","7.3. Опции и профилирование работы","8.1. Многопоточная обработка данных","8.2. Разработка повторно используемых шаблонов","8.3. Разработка юнит тестов","8.4. Создание базовых классов проекта","9.1. Модели referenceTables","9.2. Модели referenceFiles","9.3. Модели monitorRules","9.4. Модели mapTables","10.1. Установка Getl Examples","10.2. Инициализация проекта для запуска примеров","10.3. Пакет getl.examples.data","10.4. Пакет getl.example.files","10.5. Пакет getl.examples.process.init","10.6. Пакет getl.examples.process.sales","10.7. Пакет getl.examples.process.events","10.8. Модуль проекта test"],
    DREX_NODE_LINKS: ["index.htm","o_produkte.htm","ustanovka_getl.htm","rabota_s_repozitoriem_getl.htm","rabota_s_naborami_dannykh__dataset_.htm","protsessy_raboty_s_dannymi.htm","rabota_s_fajlovymi_sistemami.htm","nastrojka_getl.htm","dopolnitelnye_vozmozhnosti_getl.htm","rasshirenie_funktsionalnosti_s_pomoshchyu_easyetl.htm","repozitorij_primerov_getl_examples.htm","podklyuchenie_biblioteki_iz_repozitoriya_maven.htm","razrabotka_skripta_getl.htm","sborka_skriptov_v_biblioteku_jar_s_pomoshchyu_gradle.htm","vyzov_skripta_getl.htm","gruppirovka_obektov_repozitoriya.htm","svyazyvanie_istochnikov_v_potokakh.htm","rabota_s_jdbc_tablitsami.htm","rabota_s_jdbc_soedineniyami.htm","rabota_s_inkrementalnymi_dannymi.htm","kopirovanie_dannykh_mezhdu_istochnikami.htm","zapis_dannykh_v_istochniki.htm","chtenie_dannykh_iz_istochnika.htm","obrabotka_fajlov.htm","rabota_s_konfiguratsiyami.htm","logirovanie_raboty_skriptov.htm","optsii_i_profilirovanie_raboty.htm","mnogopotochnaya_obrabotka_dannykh.htm","razrabotka_povtorno_ispolzuemykh_shablonov.htm","razrabotka_yunit_testov.htm","sozdanie_bazovykh_klassov_proekta.htm","modeli_referencetables.htm","modeli_referencefiles.htm","modeli_monitorrules.htm","modeli_maptables.htm","ustanovka_getl_examples.htm","initsializatsiya_proekta_dlya_zapuska_primerov.htm","paket_getl_examples_data.htm","paket_getl_example_files.htm","paket_getl_examples_process_init.htm","paket_getl_examples_process_sales.htm","paket_getl_examples_process_events.htm","modul_proekta_test.htm"],
    DREX_NODE_CHILD_START: [1,11,11,15,17,20,23,24,27,31,35,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43],
    DREX_NODE_CHILD_END: [11,11,15,17,20,23,24,27,31,35,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43,43],
    DREX_MENU_TYPE: 2,
